    ...
    <ul class="nav side-menu">
      ...
      <li>
          ...
          <ul class="nav child_menu">
            ...
            <li <?php if ( $pageName == "Streets Manager") echo $currentPage; ?>><a href="<?php echo BASE_URL; if (MODERATOR_DATAMAN_STREETS == false) echo "onclick=\"return false\"";  ?>/oc-admin/dataManagement/streetManager.php"><i class="fas fa-road"></i> Streets Manager</a></li>
