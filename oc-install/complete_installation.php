...
if ($passed_step == 10) {
	...
	// Missing these two lines, causing "Undefined variable" error within installer.
	$DEFAULT_LANUGAGE					= isset($_SESSION['DEFAULT_LANGUAGE']) ? prepare_input($_SESSION['DEFAULT_LANGUAGE']) : '';
	$DEFAULT_LANUGAGE_DIRECTION			= isset($_SESSION['DEFAULT_LANGUAGE_DIRECTION']) ? prepare_input($_SESSION['DEFAULT_LANGUAGE_DIRECTION']) : '';
			...
			<div class="central-part">
				<h2><?php echo lang_key('step_11_of'); ?>
					...
					<?php } else { ?>
						...
						<!--<h3><?php //echo lang_key('updating_completed'); 
								?></h3>			-->
					<?php } ?>
				</h2>
