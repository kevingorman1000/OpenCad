					...
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
						...
						<tr>
							...
							<td><input type="radio" name="API_SECURITY" id="API_SECURITY" <?php echo ($API_SECURITY == 'true') ? 'checked' : '' ?> onfocus="textboxOnFocus('API_SECURITY_notes')" checked onblur="textboxOnBlur('API_SECURITY_notes')" value="true" />True
								<input type="radio" name="API_SECURITY" id="API_SECURITY" <?php echo ($API_SECURITY == 'false') ? 'checked' : '' ?> onfocus="textboxOnFocus('API_SECURITY_notes')" onblur="textboxOnBlur('API_SECURITY_notes')" value="false" />False
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="javascript:void(0)" id="regenerate_btn" class="form_button" /><?php echo lang_key('regenerate_keys'); ?></a>
								&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<script>
		$(document).ready(function() {
			$("#regenerate_btn").click(function() {
				$.ajax({
					url: "core_configuration.php",
					success: function(result) {
						$("input[name=AUTH_KEY]").val("<?php echo random_str(64); ?>");
						$("input[name=SECURE_AUTH_KEY]").val("<?php echo random_str(64); ?>");
						$("input[name=LOGGED_IN_KEY]").val("<?php echo random_str(64); ?>");
						$("input[name=NONCE_KEY]").val("<?php echo random_str(64); ?>");
						$("input[name=AUTH_SALT]").val("<?php echo random_str(64); ?>");
						$("input[name=SECURE_AUTH_SALT]").val("<?php echo random_str(64); ?>");
						$("input[name=LOGGED_IN_SALT]").val("<?php echo random_str(64); ?>");
						$("input[name=NONCE_SALT]").val("<?php echo random_str(64); ?>");
